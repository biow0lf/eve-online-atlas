...
ActiveRecord::Schema.define(version: 0) do
  ...
  add_index 'industryactivitymaterials', %w(typeID activityID), name: 'industryActivityMaterials_idx1', using: :btree
  ...
  add_index 'industryactivityproducts', %w(typeID activityID), name: 'industryActivityProduct_idx1', using: :btree
  ...
  add_index 'industryactivityskills', %w(typeID activityID), name: 'industryActivitySkills_idx1', using: :btree
  ...
  add_index 'invitems', %w(ownerID locationID), name: 'items_IX_OwnerLocation', using: :btree
  ...
  add_index 'invuniquenames', %w(groupID itemName), name: 'invUniqueNames_IX_GroupName', using: :btree
  ...
  add_index 'mapdenormalize', %w(groupID constellationID), name: 'mapDenormalize_IX_groupConstellation', using: :btree
  add_index 'mapdenormalize', %w(groupID regionID), name: 'mapDenormalize_IX_groupRegion', using: :btree
  add_index 'mapdenormalize', %w(groupID solarSystemID), name: 'mapDenormalize_IX_groupSystem', using: :btree
  ...
  add_index 'mapdenormalize', %w(solarSystemID x y z itemName itemID), name: 'mapDenormalize_gis', length: {'solarSystemID' =>nil, 'x' =>nil, 'y' =>nil, 'z' =>nil, 'itemName' =>40, 'itemID' =>nil}, using: :btree
